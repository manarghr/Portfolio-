  ...
  site: {
    ...
    fields: [
      ...
      },
      {
        ...
        help: 'Country code first, no + and no spaces (Algeria is 213). Leave empty to hide the WhatsApp link.',
      },
      ...
      { name: 'linkedin', label: 'LinkedIn link', type: 'url', placeholder: 'https://www.linkedin.com/in/…' },
      {
        ...
        label: 'CV file',
        type: 'text',
        placeholder: '/ManarGherib_CV.pdf',
    ...
    blank: {
      email: '', whatsapp: '', github: '', linkedin: '', cv: '/cv.pdf',
