  ...
  return (
    <section className="section" id="contact">
      ...
      <div className="section-inner">
        <p className="section-eyebrow">{headings.contactEyebrow}</p>
        <h2 className="section-heading">{headings.contactHeading}</h2>
        <p className="section-sub">{site.contactSub}</p>
        ...
        <div className="contact-wrap reveal">
          ...
          <aside className="contact-aside">
            ...
            {site.cv?.trim() && (
            <a className="contact-cv" href={site.cv} download>
