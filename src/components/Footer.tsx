        ...
        <div className="footer-top">
          <div>
            <div className="footer-brand">
              <span className="grad-text">{site.footerName}</span>
            </div>
            <p className="footer-brand-sub">{site.footerTagline}</p>
          </div>
          ...
          <nav className="footer-nav">
            ...
            <div className="footer-nav-col">
              <h4>Elsewhere</h4>
              <a href={externalUrl(site.github)} target="_blank" rel="noopener noreferrer">GitHub</a>
              <a href={externalUrl(site.linkedin)} target="_blank" rel="noopener noreferrer">LinkedIn</a>
              {site.cv?.trim() && <a href={site.cv} target="_blank">Résumé</a>}
            </div>
          </nav>
        </div>

        <div className="footer-bottom">
          <p className="footer-copy"><span className="footer-star">✦</span> © {year} {site.footerName}. All rights reserved.</p>
